<template>
  <PpModal :open="isOpen" size="md" :title="t('qr.generate.title')" @close="close">
    <!-- Player Info -->
    ...
    <div v-if="qrCodeDataUrl" class="qr-checkin-display">
      ...
      <div class="qr-checkin-code-wrapper">
        <img :src="qrCodeDataUrl" :alt="t('qr.generate.qrCodeAlt')" class="qr-checkin-code-image" />
      </div>
...
import { qrCodeOutline, copyOutline, checkmarkOutline, alertCircleOutline } from 'ionicons/icons'
