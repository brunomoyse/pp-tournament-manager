...
- Name: e2e/tests/new-club-onboarding.public.spec.ts >> New club onboarding (public) >> a fresh club can reach a creatable tournament form
- Location: e2e/tests/new-club-onboarding.public.spec.ts:64:3
